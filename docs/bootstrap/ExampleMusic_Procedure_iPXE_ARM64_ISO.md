...
All steps are performed on the Edinburgh provisioning host (`192.168.139.50`, bootstrap-only, no formal hostname) running Debian Trixie, unless otherwise noted.

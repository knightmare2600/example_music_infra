...
graph TD
    ...
    T_RTR["📡 EXARTRCLD001<br/>Real Router At The Standard .1 Slot, Same As Every Other...<br/>192.168.69.1"]
    T_VRK --> T_RTR
    ...
    style T_RMM fill:#000000,stroke:#FFFFFF,color:#FFFFFF
    style T_ZAB fill:#000000,stroke:#FFFFFF,color:#FFFFFF

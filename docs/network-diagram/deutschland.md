...
graph TD
    ...
    subgraph NEW_BON ["🆕 New Network (current)"]
      ...
      N_NAS["🗃️ EXANASBON001 · NAS · .19"]
      N_RDR["🔐 EXARDRBON001 · RDR · .21"]
      N_BMC["🔧 EXABMCBON001 · BMC 1 · .2"]
      N_DCS["🗝️ EXADCSBON001 · DCS 1 · .10"]
      N_FWL["🧱 EXAFWLBON001 · LAN face · .253"]
      N_FWL2["🧱 EXAFWLBON002 · FWL 2 · .254"]
      N_PVE["🗂️ EXAPVEBON001 · PVE 1 · .5"]
      N_WAP["📶 EXAWAPBON001 · WAP 1 · .82"]
...
graph TD
    ...
    subgraph NEW_BER ["🆕 New Network (current)"]
      ...
      N_NAS["🗃️ EXANASBER001 · NAS · .19"]
      N_RDR["🔐 EXARDRBER001 · RDR · .21"]
      N_BMC["🔧 EXABMCBER001 · BMC 1 · .2"]
      N_DCS["🗝️ EXADCSBER001 · DCS 1 · .10"]
      N_FWL["🧱 EXAFWLBER001 · LAN face · .253"]
      N_FWL2["🧱 EXAFWLBER002 · FWL 2 · .254"]
      N_PVE["🗂️ EXAPVEBER001 · PVE 1 · .5"]
      N_SWI["🔀 EXASWIBER001 · SWI 1 · .250"]
      N_WAP["📶 EXAWAPBER001 · WAP 1 · .82"]
    end
...
graph TD
    ...
    subgraph NEW_MUN ["🆕 New Network (current)"]
      ...
      N_NAS["🗃️ EXANASMUN001 · NAS · .19"]
      N_RDR["🔐 EXARDRMUN001 · RDR · .21"]
      N_BMC["🔧 EXABMCMUN001 · BMC 1 · .2"]
      N_DCS["🗝️ EXADCSMUN001 · DCS 1 · .10"]
      N_FWL["🧱 EXAFWLMUN001 · LAN face · .253"]
      N_FWL2["🧱 EXAFWLMUN002 · FWL 2 · .254"]
      N_PVE["🗂️ EXAPVEMUN001 · PVE 1 · .5"]
      N_WAP["📶 EXAWAPMUN001 · WAP 1 · .82"]
...
graph TD
    ...
    subgraph NEW_DRS ["🆕 New Network (current)"]
      ...
      N_NAS["🗃️ EXANASDRS001 · NAS · .19"]
      N_RDR["🔐 EXARDRDRS001 · RDR · .21"]
      N_BMC["🔧 EXABMCDRS001 · BMC 1 · .2"]
      N_DCS["🗝️ EXADCSDRS001 · DCS 1 · .10"]
      N_FWL["🧱 EXAFWLDRS001 · LAN face · .253"]
      N_FWL2["🧱 EXAFWLDRS002 · FWL 2 · .254"]
      N_PVE["🗂️ EXAPVEDRS001 · PVE 1 · .5"]
      N_SWI["🔀 EXASWIDRS001 · SWI 1 · .250"]
      N_WAP["📶 EXAWAPDRS001 · WAP 1 · .82"]
    end
...
graph TD
    ...
    subgraph NEW_DUS ["🆕 New Network (current)"]
      ...
      N_NAS["🗃️ EXANASDUS001 · NAS · .19"]
      N_RDR["🔐 EXARDRDUS001 · RDR · .21"]
      N_BMC["🔧 EXABMCDUS001 · BMC 1 · .2"]
      N_DCS["🗝️ EXADCSDUS001 · DCS 1 · .10"]
      N_FWL["🧱 EXAFWLDUS001 · LAN face · .253"]
      N_FWL2["🧱 EXAFWLDUS002 · FWL 2 · .254"]
      N_PVE["🗂️ EXAPVEDUS001 · PVE 1 · .5"]
      N_SWI["🔀 EXASWIDUS001 · SWI 1 · .250"]
      N_WAP["📶 EXAWAPDUS001 · WAP 1 · .82"]
    end

...
graph TD
    ...
    T_RTR --> T_SWI3
    T_PVE["🗂️ EXAPVEBON001<br/>PVE 1<br/>192.168.228.5 — planned"]
    T_RTR --> T_PVE
    T_PVE2["🗂️ EXAPVEBON002<br/>PVE 2<br/>192.168.228.6 — planned"]
    T_RTR --> T_PVE2
    T_NAS["🗃️ EXANASBON001<br/>NAS<br/>192.168.228.19"]
    T_NAS["🗃️ EXANASBON001<br/>NAS 1<br/>192.168.228.19 — planned"]
    T_RDR["🔐 EXARDRBON001<br/>RDR<br/>192.168.228.21"]
    T_RDR["🔐 EXARDRBON001<br/>RDR 1<br/>192.168.228.21 — planned"]
    ...
    T_FWL["🧱 EXAFWLBON001<br/>FWL 1<br/>192.168.228.253 — planned"]
    ...
    T_ILO["🔧 EXAILOBON001<br/>ILO 1<br/>192.168.228.3 — planned"]
    T_OTH_LAP --> T_VCU --> T_TVS --> T_ILO
    T_WKS --> T_CAM --> T_RAC
...
graph TD
    ...
    T_RTR --> T_SWI3
    T_SWI["🔀 EXASWIBER001<br/>SWI 1<br/>192.168.113.250 — planned"]
    T_RTR --> T_SWI
    T_PVE["🗂️ EXAPVEBER001<br/>PVE 1<br/>192.168.113.5 — planned"]
    T_RTR --> T_PVE
    T_PVE2["🗂️ EXAPVEBER002<br/>PVE 2<br/>192.168.113.6 — planned"]
    T_RTR --> T_PVE2
    T_NAS["🗃️ EXANASBER001<br/>NAS<br/>192.168.113.19"]
    T_NAS["🗃️ EXANASBER001<br/>NAS 1<br/>192.168.113.19 — planned"]
    T_RDR["🔐 EXARDRBER001<br/>RDR<br/>192.168.113.21"]
    T_RDR["🔐 EXARDRBER001<br/>RDR 1<br/>192.168.113.21 — planned"]
    T_WAP["📶 EXAWAPBER001<br/>WAP 1<br/>192.168.113.82"]
    T_WAP["📶 EXAWAPBER001<br/>WAP 1<br/>192.168.113.82 — planned"]
    ...
    T_SBC["🛡️ EXASBCBER001<br/>SBC 1<br/>192.168.113.48 — planned"]
    T_FWL["🧱 EXAFWLBER001<br/>LAN Face<br/>192.168.113.253"]
    T_FWL["🧱 EXAFWLBER001<br/>FWL 1<br/>192.168.113.253 — planned"]
    T_PVE --> T_DCS --> T_SBC --> T_SBC --> T_FWL --> T_FWL
    T_ILO["🔧 EXAILOBER001<br/>ILO 1<br/>192.168.113.3 — planned"]
    T_RAC["🔧 EXARACBER002<br/>RAC 2<br/>192.168.113.4 — planned"]
    style T_VRK fill:#000000,stroke:#FFFFFF,color:#FFFFFF
    style T_RTR fill:#000000,stroke:#FFFFFF,color:#FFFFFF
...
graph TD
    T_VRK["☁️ VRK — vRACK, 192.168.139.0/24"]
    T_RTR["📡 EXARTRMUN001<br/>WAN Edge Router<br/>192.168.189.1"]
    T_VRK --> T_RTR
    ...
    T_RTR --> T_SWI3
    T_PVE["🗂️ EXAPVEMUN001<br/>PVE 1<br/>192.168.189.5 — planned"]
    T_RTR --> T_PVE
    T_PVE2["🗂️ EXAPVEMUN002<br/>PVE 2<br/>192.168.189.6 — planned"]
    T_RTR --> T_PVE2
    T_NAS["🗃️ EXANASMUN001<br/>NAS<br/>192.168.189.19"]
    T_NAS["🗃️ EXANASMUN001<br/>NAS 1<br/>192.168.189.19 — planned"]
    T_RDR["🔐 EXARDRMUN001<br/>RDR<br/>192.168.189.21"]
    T_RDR["🔐 EXARDRMUN001<br/>RDR 1<br/>192.168.189.21 — planned"]
    T_WAP["📶 EXAWAPMUN001<br/>WAP 1<br/>192.168.189.82"]
    T_WAP["📶 EXAWAPMUN001<br/>WAP 1<br/>192.168.189.82 — planned"]
    T_SWI3 --> T_NAS --> T_NAS --> T_RDR --> T_RDR --> T_WAP --> T_WAP
    T_DCS["🗝️ EXADCSMUN001<br/>DCS 1<br/>192.168.189.10"]
    T_DCS["🗝️ EXADCSMUN001<br/>DCS 1<br/>192.168.189.10 — planned"]
    T_SBC["🛡️ EXASBCMUN001<br/>VoIP SBC<br/>192.168.189.48"]
    T_FWL["🧱 EXAFWLMUN001<br/>LAN Face<br/>192.168.189.253"]
    T_FWL["🧱 EXAFWLMUN001<br/>FWL 1<br/>192.168.189.253 — planned"]
    T_PVE --> T_DCS --> T_DCS --> T_SBC --> T_FWL --> T_FWL
    ...
    T_ILO["🔧 EXAILOMUN001<br/>ILO 1<br/>192.168.189.3 — planned"]
    T_WKS --> T_RAC
    T_OTH_LAP --> T_ILO
    style T_VRK fill:#000000,stroke:#FFFFFF,color:#FFFFFF
    style T_RTR fill:#000000,stroke:#FFFFFF,color:#FFFFFF
...
graph TD
    ...
    T_RTR --> T_SWI3
    T_SWI["🔀 EXASWIDRS001<br/>SWI 1<br/>192.168.153.250 — planned"]
    T_RTR --> T_SWI
    T_PVE["🗂️ EXAPVEDRS001<br/>PVE 1<br/>192.168.153.5 — planned"]
    T_RTR --> T_PVE
    T_PVE2["🗂️ EXAPVEDRS002<br/>PVE 2<br/>192.168.153.6 — planned"]
    T_RTR --> T_PVE2
    T_NAS["🗃️ EXANASDRS001<br/>NAS<br/>192.168.153.19"]
    T_NAS["🗃️ EXANASDRS001<br/>NAS 1<br/>192.168.153.19 — planned"]
    T_RDR["🔐 EXARDRDRS001<br/>RDR<br/>192.168.153.21"]
    T_RDR["🔐 EXARDRDRS001<br/>RDR 1<br/>192.168.153.21 — planned"]
    T_WAP["📶 EXAWAPDRS001<br/>WAP 1<br/>192.168.153.82"]
    T_WAP["📶 EXAWAPDRS001<br/>WAP 1<br/>192.168.153.82 — planned"]
    T_SWI --> T_NAS --> T_NAS --> T_RDR --> T_RDR --> T_WAP --> T_WAP
    T_DCS["🗝️ EXADCSDRS001<br/>DCS 1<br/>192.168.153.10"]
    T_DCS["🗝️ EXADCSDRS001<br/>DCS 1<br/>192.168.153.10 — planned"]
    T_SBC["🛡️ EXASBCDRS001<br/>SBC<br/>192.168.153.48"]
    T_SBC["🛡️ EXASBCDRS001<br/>SBC 1<br/>192.168.153.48 — planned"]
    T_FWL["🧱 EXAFWLDRS001<br/>LAN Face<br/>192.168.153.253"]
    T_FWL["🧱 EXAFWLDRS001<br/>FWL 1<br/>192.168.153.253 — planned"]
    T_PVE --> T_DCS --> T_DCS --> T_SBC --> T_SBC --> T_FWL --> T_FWL
    T_ILO["🔧 EXAILODRS001<br/>ILO 1<br/>192.168.153.3 — planned"]
    T_RAC["🔧 EXARACDRS002<br/>RAC 2<br/>192.168.153.4 — planned"]
    style T_VRK fill:#000000,stroke:#FFFFFF,color:#FFFFFF
    style T_RTR fill:#000000,stroke:#FFFFFF,color:#FFFFFF
    style T_BMC fill:#000000,stroke:#FFFFFF,color:#FFFFFF
    style T_PVE fill:#000000,stroke:#FFFFFF,color:#FFFFFF
...
graph TD
    ...
    T_RTR --> T_SWI3
    T_SWI["🔀 EXASWIDUS001<br/>SWI 1<br/>192.168.211.250 — planned"]
    T_RTR --> T_SWI
    T_PVE["🗂️ EXAPVEDUS001<br/>PVE 1<br/>192.168.211.5 — planned"]
    T_RTR --> T_PVE
    T_PVE2["🗂️ EXAPVEDUS002<br/>PVE 2<br/>192.168.211.6 — planned"]
    T_RTR --> T_PVE2
    T_NAS["🗃️ EXANASDUS001<br/>NAS<br/>192.168.211.19"]
    T_NAS["🗃️ EXANASDUS001<br/>NAS 1<br/>192.168.211.19 — planned"]
    T_RDR["🔐 EXARDRDUS001<br/>RDR<br/>192.168.211.21"]
    T_RDR["🔐 EXARDRDUS001<br/>RDR 1<br/>192.168.211.21 — planned"]
    T_WAP["📶 EXAWAPDUS001<br/>WAP 1<br/>192.168.211.82"]
    T_WAP["📶 EXAWAPDUS001<br/>WAP 1<br/>192.168.211.82 — planned"]
    T_SWI --> T_NAS --> T_NAS --> T_RDR --> T_RDR --> T_WAP --> T_WAP
    T_DCS["🗝️ EXADCSDUS001<br/>DCS 1<br/>192.168.211.10"]
    T_DCS["🗝️ EXADCSDUS001<br/>DCS 1<br/>192.168.211.10 — planned"]
    T_SBC["🛡️ EXASBCDUS001<br/>SBC<br/>192.168.211.48"]
    T_SBC["🛡️ EXASBCDUS001<br/>SBC 1<br/>192.168.211.48 — planned"]
    T_FWL["🧱 EXAFWLDUS001<br/>LAN Face<br/>192.168.211.253"]
    T_FWL["🧱 EXAFWLDUS001<br/>FWL 1<br/>192.168.211.253 — planned"]
    T_PVE --> T_DCS --> T_DCS --> T_SBC --> T_SBC --> T_FWL --> T_FWL
    T_ILO["🔧 EXAILODUS001<br/>ILO 1<br/>192.168.211.3 — planned"]
    T_RAC["🔧 EXARACDUS002<br/>RAC 2<br/>192.168.211.4 — planned"]
    style T_VRK fill:#000000,stroke:#FFFFFF,color:#FFFFFF
    style T_RTR fill:#000000,stroke:#FFFFFF,color:#FFFFFF
    style T_BMC fill:#000000,stroke:#FFFFFF,color:#FFFFFF
    style T_PVE fill:#000000,stroke:#FFFFFF,color:#FFFFFF

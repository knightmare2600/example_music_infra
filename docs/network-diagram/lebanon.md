...
> fabricated template content — zero real `devices.csv` rows exist for BRT, and Robert confirmed
> it's an expansion office. Converted to the same "New Build Location" placeholder pattern used
> for FRD/NYB/SEA/SFO/FRE/DRS/DUS/GOT/OSL/AMS/MIL/VIE.

```mermaid
graph TD
    subgraph OLD_BRT ["🏗️ New Build Location — no legacy infrastructure existed here"]
...
graph TD
    ...
    T_RTR --> T_SWI3
    T_SWI["🔀 EXASWIBRT001<br/>SWI 1<br/>192.168.169.250 — planned"]
    T_RTR --> T_SWI
    T_PVE["🗂️ EXAPVEBRT001<br/>PVE 1<br/>192.168.169.5 — planned"]
    T_RTR --> T_PVE
    T_PVE2["🗂️ EXAPVEBRT002<br/>PVE 2<br/>192.168.169.6 — planned"]
    T_RTR --> T_PVE2
    T_NAS["🗃️ EXANASBRT001<br/>NAS<br/>192.168.169.19"]
    T_NAS["🗃️ EXANASBRT001<br/>NAS 1<br/>192.168.169.19 — planned"]
    T_RDR["🔐 EXARDRBRT001<br/>RDR<br/>192.168.169.21"]
    T_RDR["🔐 EXARDRBRT001<br/>RDR 1<br/>192.168.169.21 — planned"]
    T_WAP["📶 EXAWAPBRT001<br/>WAP 1<br/>192.168.169.82"]
    T_WAP["📶 EXAWAPBRT001<br/>WAP 1<br/>192.168.169.82 — planned"]
    T_SWI --> T_NAS --> T_NAS --> T_RDR --> T_RDR --> T_WAP --> T_WAP
    T_DCS["🗝️ EXADCSBRT001<br/>DCS 1<br/>192.168.169.10"]
    T_DCS["🗝️ EXADCSBRT001<br/>DCS 1<br/>192.168.169.10 — planned"]
    T_SBC["🛡️ EXASBCBRT001<br/>SBC<br/>192.168.169.48"]
    T_SBC["🛡️ EXASBCBRT001<br/>SBC 1<br/>192.168.169.48 — planned"]
    T_FWL["🧱 EXAFWLBRT001<br/>LAN Face<br/>192.168.169.253"]
    T_FWL["🧱 EXAFWLBRT001<br/>FWL 1<br/>192.168.169.253 — planned"]
    T_PVE --> T_DCS --> T_DCS --> T_SBC --> T_SBC --> T_FWL --> T_FWL
    T_ILO["🔧 EXAILOBRT001<br/>ILO 1<br/>192.168.169.3 — planned"]
    T_RAC["🔧 EXARACBRT002<br/>RAC 2<br/>192.168.169.4 — planned"]

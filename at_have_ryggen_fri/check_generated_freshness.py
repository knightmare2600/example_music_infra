...
main.ini, rudder.ini, salt.ini, meshcentral.ini, and tacticalrmm.ini are NOT
generator output (they come from ansibleme.sh's discovery scan /
hand-curation) and are deliberately excluded from this check.
...
NOT_GENERATOR_OWNED = {"main.ini", "rudder.ini", "salt.ini", "meshcentral.ini", "tacticalrmm.ini"}

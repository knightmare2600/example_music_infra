...
declare -A HUB_KNOWN_PUBKEY=(
  [CLD]="pAkY7PZHJy8/myXwQllAdf6l6NEtYVimiANKikZHuH0="   # EXAFWLCLD001
  [FAL]="yxYnCsZwxDmv6WrduGTC7pnW3sUxob1GGYpttPfGbmk="   # EXAFWLFAL001
  [ODE]="gFK4oQNKN/a2UZvoil43OvOcjp2B6gT4YQ8IUqWrZ1o="   # EXAFWLODE001
  [BRK]="CSpL1NJl4jgeJDf6TccixMGv8JOSH7XS7pErjKSuoT4="   # EXAFWLBRK001
)
...
HUB_ODE_SPOKES=(AAR AMS BER BON BRT CPH DRS DUS FAX FRE GOT KGE KOR MIL MUN OSL VIE)
...
echo -e "    ${CYAN}hub-regional  — regional hub (CLD, ODE, BRK)${NC}"

...
#       Example Music GitHub repo and must be cloned separately:
#
#         git clone https://github.com/knightmare2600/example_music_infra.git
#         cp -r example_music_infra/ansible/* /home/ansible/ansible/
#
# -------------------------------------------------------------------------------------------------
# Version history
# -------------------------------------------------------------------------------------------------
...
mkdir -p \
  ...
  "${CALLBACK_DIR}" \
  "${PLAYBOOKS_DIR}/proxmox" \
  "${PLAYBOOKS_DIR}/linux" \
  "${PLAYBOOKS_DIR}/windows" \
  "${PLAYBOOKS_DIR}/bind9" \
  "${PLAYBOOKS_DIR}/firewallme" \
  "${PLAYBOOKS_DIR}/rudder" \
  "${PLAYBOOKS_DIR}/windows_bootstrap" \
  "${PLAYBOOKS_DIR}/windows_dc" \
  "${FILES_DIR}" \
...
# ------------------------------------------------------------------------------
# 12. GitHub repo reminder (playbooks are NOT generated here)
# ------------------------------------------------------------------------------
section "12. Playbooks — clone from GitHub"

echo
echo -e "${YELLOW}  ╔═══════════════════════════════════════════════════════════════════╗${NC}"
echo -e "${YELLOW}  ║   IMPORTANT — Playbooks are not generated by this script          ║${NC}"
echo -e "${YELLOW}  ║   They live in the Example Music GitHub repository                ║${NC}"
echo -e "${YELLOW}  ╚═══════════════════════════════════════════════════════════════════╝${NC}"
echo
echo -e "${CYAN}  Clone the repo and copy the ansible directory into place:${NC}"
echo
echo -e "${GREEN}  cd /tmp${NC}"
echo -e "${GREEN}  git clone https://github.com/knightmare2600/example_music_infra.git${NC}"
echo -e "${GREEN}  cp -r example_music_infra/ansible/playbooks   ${ANSIBLE_DIR}/${NC}"
echo -e "${GREEN}  cp -r example_music_infra/ansible/handlers    ${ANSIBLE_DIR}/${NC}"
echo -e "${GREEN}  cp -r example_music_infra/ansible/vars        ${ANSIBLE_DIR}/${NC}"
echo -e "${GREEN}  cp -r example_music_infra/ansible/host_vars   ${ANSIBLE_DIR}/${NC}"
echo -e "${GREEN}  cp -r example_music_infra/ansible/docs        ${ANSIBLE_DIR}/${NC}"
echo -e "${GREEN}  chown -R ${ANSIBLE_USER}:${ANSIBLE_USER} ${ANSIBLE_DIR}${NC}"
echo
echo -e "${CYAN}  group_vars and configs/inventory are managed by this script${NC}"
echo -e "${CYAN}  and should NOT be overwritten from the repo.${NC}"
echo
...
echo -e "${YELLOW}  ╚═══════════════════════════════════════════════════════════════════╝${NC}"
echo
echo -e "${CYAN}  1. Clone the playbooks from GitHub:${NC}"
echo -e "${GREEN}     cd /tmp${NC}"
echo -e "${GREEN}     git clone https://github.com/knightmare2600/example_music_infra.git${NC}"
echo -e "${GREEN}     cp -r example_music_infra/ansible/playbooks ${ANSIBLE_DIR}/${NC}"
echo -e "${GREEN}     cp -r example_music_infra/ansible/handlers  ${ANSIBLE_DIR}/${NC}"

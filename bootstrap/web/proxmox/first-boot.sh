...
echo -e "${C}  |  configs/inventory/, then run proxmox/site.yml --     |${NC}"
echo -e "${C}  |  which does everything else this script used to      |${NC}"
echo -e "${C}  |  (repo fix, packages, MOTD, /etc/.environment,        |${NC}"
echo -e "${C}  |  single-disk warning, dotfiles, kvm group, etc.).     |${NC}"
echo -e "${C}  +------------------------------------------------------+${NC}"
echo
